...
public class GroupButtonBindings {
     ...
     * as they are held. 
     * @param command - The command to be ran when the buttons are held.
     * @param buttons - The buttons to run the command when held.
     */
     ...
     * @param command - The command to be ran when the buttons are released.
     * @param buttons - The buttons to run the command when they are released
     */
     ...
     * pressed.
     * @param command - The command to be ran when the buttons are pressed.
     * @param buttons - The buttons to run the command when they are pressed
     */
