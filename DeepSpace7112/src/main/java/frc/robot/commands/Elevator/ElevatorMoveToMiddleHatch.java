...
public class ElevatorMoveToMiddleHatch extends CommandGroup {
  /**
   * The command makes the elevator go to the middle hatch using a PID loop with the encoder.
   * If the elevator passes by the hall effect sensor the encoder will reset.
   */
  public ElevatorMoveToMiddleHatch() {
    ...
    addSequential(new MoveBasicSubsystemWithPID(Robot.elevator, SubsystemComponents.Elevator.encoder, 
                  SubsystemConstants.Elevator.kRocketMiddleHatchHeight, 
