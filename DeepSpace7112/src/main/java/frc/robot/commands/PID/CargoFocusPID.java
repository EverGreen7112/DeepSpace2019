...
public class CargoFocusPID extends CommandGroup {
  ...
  public CargoFocusPID() {
    ...
    addSequential(new DriveArcadeWithPID (
        ...
        SubsystemConstants.cameras.kCameraWidth.get(), //The range of values the PID system can recieve as input - the amount of pixels in the camera.
